# RnnTutorialPart2
To practice Denny Brit's RNN tutorial part2 (http://www.wildml.com/2015/09/recurrent-neural-networks-tutorial-part-2-implementing-a-language-model-rnn-with-python-numpy-and-theano/)
...
git clone https://github.com/dennybritz/rnn-tutorial-rnnlm # git clone command to clone the github repository rnn-tutorial-rnnlm
cd rnn-tutorial-rnnlm # change directory

# Create a new virtual environment (optional, but recommended)
virtualenv venv # this creates an isolated Python environment named venv under the current path (https://virtualenv.pypa.io/en/stable/)
